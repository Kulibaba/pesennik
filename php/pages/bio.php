  ...
  <div class="main-container" style="margin:20px;">
	  <div  id="short_bio">
		...
		<div class="span7" id="short_bio_table" >
			...
			<table class="bio-table" cellpadding="5" cellspacing="3">
			...
			<div style="float:right;">
				...
				<div style="display:inline;">
					<span style="border:1px solid #541;width:182; height: 25px; ">
						<!-- margin for element 2px , w:22 h:16-->
						<img src="" width="22" height="16" alt="google" />
						<img src="" width="22" height="16" alt="vk" />
						<img src="" width="22" height="16" alt="face" />
	...
	<div class="bio-content">
		...
		<div class="bio-section">	  
			<span class="bio-section-title" > О себе </span>
			<div class="bio-section-text">
				<ul>
					<li>[Думаю, что все равно что писать в этом разеделе]</li>
					<li>Любит ездить верхом на верблюде и плювать им на поклонников.</li>
					<li>Часто развлекается завязывая глаза перед дошкольными учереждениями и катаясь по кругу.</li>
				</ul>
			</div>
		</div>
		...
		<div class="bio-section">	  
			...
			<div id="SlideItMoo_outer">	
					...
					<div id="SlideItMoo_inner" style="width: 950px;">			
					<!-- actual elements container, usually having a width bigger than the one of SlideItMoo_inner -->
						<div id="SlideItMoo_items" style="width: 2680px; margin-left: 0px;">
							...
							<div class="SlideItMoo_element">
								...
								<a href="img/artist.jpg" rel="lightbox[galerie]" target="_blank">
									<img src="img/artist.jpg" /></a>
							...
							<div class="SlideItMoo_element">
								<strong>3: Phone</strong>
								<a href="img/artist.jpg" rel="lightbox[galerie]" target="_blank">
									<img src="img/artist.jpg" /></a>
								Vestibulum eleifend scelerisque purus  
							</div>
							<div class="SlideItMoo_element">
								<strong>4: Lock</strong>
								<a href="img/artist.jpg" rel="lightbox[galerie]" target="_blank">
									<img src="img/artist.jpg" /></a>
							...
							<div class="SlideItMoo_element">
								<strong>11: Address</strong>
								<a href="img/artist.jpg" rel="lightbox[galerie]" target="_blank">
									<img src="img/artist.jpg" /></a>
								Nam porta tellus ac urna    
							</div>							
							<div class="SlideItMoo_element">
								<strong>22: Ads</strong>
								<a href="img/artist.jpg" rel="lightbox[galerie]" target="_blank">
									<img src="img/artist.jpg" /></a>
								Praesent pellentesque eros nec nisl    
							</div>
							<div class="SlideItMoo_element">
								<strong>33: Phone</strong>
								<a href="img/artist.jpg" rel="lightbox[galerie]" target="_blank">
									<img src="img/artist.jpg" /></a>
								Vestibulum eleifend scelerisque purus  
							</div>
							<div class="SlideItMoo_element">
								<strong>44: Lock</strong>
								<a href="img/artist.jpg" rel="lightbox[galerie]" target="_blank">
									<img src="img/artist.jpg" /></a>
								 Felis nulla iaculis lacus
							</div>
	...
	<script language="javascript" type="text/javascript">
		...
		<link rel="stylesheet" type="text/css" href="css/gallery/horizontal.css" />
